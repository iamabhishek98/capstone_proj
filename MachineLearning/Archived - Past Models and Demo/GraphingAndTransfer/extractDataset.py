...
# Definitions
BASEPATH = os.getcwd()
SAVEFOLDER = 'GraphingAndTransfer/raw'
PROCESSEDFOLDER = 'GraphingAndTransfer/processed'
DANCEMOVENAMES = ("dab","elbowkick","gun","hair","listen","pointhigh","sidepump","wipetable")
IS_RETURN_DATAFRAME = False

#Changeable Parameters
NUMBER_OF_AFTER_SAMPLES = None #Number of samples to include in dance move after end detected
NUMBER_OF_BEFORE_SAMPLES = None #Number of samples to include in dance move before start detected
MINIMUM_MOVE_TIME = None #Minimum number of samples to be considered a move. Set this too low and you will get garbage dance samples
...
def processData(a, b, c):
    global NUMBER_OF_AFTER_SAMPLES
    global NUMBER_OF_BEFORE_SAMPLES
    global MINIMUM_MOVE_TIME
    
    NUMBER_OF_AFTER_SAMPLES = a
    NUMBER_OF_BEFORE_SAMPLES = b
    MINIMUM_MOVE_TIME = c
